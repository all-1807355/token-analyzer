...
```
cd existing_repo
git remote add origin https://gitlab.com/amedeoallella/thesis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/amedeoallella/thesis/-/settings/integrations)
